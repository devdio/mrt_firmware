...
//--------------------------------------------------------
int MPU6050::angleLeft() {
	float x = angleX;
	if (x > 100 && x < 160 ) {
		return 90 - int(map(x, 100, 160, 0, 90));
	} else {
		return 0;
	 }
}

int MPU6050::angleRight(){
	float x = angleX;
	if (x > -170 && x < -110 ){
		return 90 - int(map(x, -110, -170, 0, 90));
	} else {
		return 0;
	 }
}
...
int MPU6050::angleUp(){
	float y = angleY;
	if (y > 5 && y < 75 )	{
		return int(map(y, 5, 75, 0, 90));
	}	else	{
		return 0;
	 }
}

int MPU6050::angleDown(){
	float y = angleY;
	if (y > -85 && y < -15 )	{
		return int(map(y, -15, -85, 0, 90));
	}	else	{
		return 0;
	 }
}
